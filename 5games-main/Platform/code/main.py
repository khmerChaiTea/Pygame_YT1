...
class Game:
    ...
    def creat_bullet(self, pos, direction):
    ...
    def setup(self):
        ...
        for obj in tmx_map.get_layer_by_name('Entities'):
            if obj.name == 'Player':
                self.player = Player((obj.x, obj.y), self.all_sprites, self.collision_sprites, self.player_frames, self.creat_bullet)
                
        Worm(self.worm_frames, (300, 500), self.all_sprites)
